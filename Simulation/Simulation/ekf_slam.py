...
class Slam:
    ...
    def observation_model(self, uTrue):
        """
        ...
        if parameters.realtime:
            # APPEL CAPTEURS DE DISTANCE
            # PAS DE MAJ xTrue, puisqu'on n'y a pas accès.
            # L'entrée est déjà considérée comme bruitée, puisqu'elle vient du capteur de vitesse
            pass
    ...
    def gnss_model(self):
        ...
        if parameters.realtime:
            # APPEL CENTRALE GNSS
            return self.xTrue[0:2] # Par défault
        else :
    ...
    def get_estimate_full_motion(self, uTrue):
        # Simulate motion and generate u and y
        self.xTrue, y, u =  self.observation_model(uTrue)
        xGnss = self.gnss_model()
