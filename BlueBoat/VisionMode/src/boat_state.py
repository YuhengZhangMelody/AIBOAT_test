...
class ThreadSafeBoatState:
    ...
    def _init_data(self):
        self._data = {
            ...
            "Cameras": {
                config.grey_id_cam : {"XCam_boat": -0.36, "YCam_boat": 0, "YawCam_deg": 0.0, "FovCam_deg": 60.0},
                config.black_id_cam: {"XCam_boat": 0.36, "YCam_boat": 0, "YawCam_deg": 0.0, "FovCam_deg": 60.0},
